...
:url-repo: https://github.com/hyperpolymath/asdf-nickel-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-nickel-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-nickel-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-nickel-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Nickel] versions.
...
Nickel is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Nickel versions per project

|**Project Isolation**
|Pin Nickel per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Nickel version
...
=== Installing Nickel Versions

[source,bash]
----
asdf list all nickel
asdf install nickel latest
asdf install nickel 0.1.0
----
...
[source,bash]
----
asdf global nickel 0.1.0
asdf local nickel 0.1.0
asdf current nickel
nickel --version
----
...
* Ensure `nickel` is on PATH after installation.
* Verify the installed version with `nickel --version`.
